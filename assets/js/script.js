...
function initMobileMenu() {
    if ($('.mobile-menu').length && $('.main-header .menu-area .main-menu').length) {
        ...
        $('.mobile-menu li.dropdown .dropdown-btn').remove();
        $('.mobile-menu li.dropdown').append('<div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>');
